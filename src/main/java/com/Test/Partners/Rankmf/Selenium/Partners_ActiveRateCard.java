...
public class Partners_ActiveRateCard extends PartnerTestBase {
	...
	public static void SearchAMC() throws InterruptedException
	{
        ...
        Thread.sleep(10000);
        WebElement amcsearch=driver.findElement(By.xpath("//input[@id='amc400040']"));
        amcsearch.click();
        Thread.sleep(5000);
	...
	public static void investAmount() throws InterruptedException, AWTException
	{
		...
		WebElement Amount=driver.findElement(By.xpath("//tbody//tr[1]//td[6]//input[@class='investment-amount']"));
		Amount.click();
	...
	public static void SchemeTypeAndSubSchemeType() throws AWTException, InterruptedException
	{
		...
		Thread.sleep(20000);
			WebElement schemetype=driver.findElement(By.xpath("//div[contains(@class,'group scheme-type-wrapper border-bottom')]//ul[@id='scheme-type']//li[1]//label//input[@type='checkbox']"));
			schemetype.click();		 
		Thread.sleep(3000);
		WebElement invest=driver.findElement(By.xpath("//div[@id='rate-card-container-active']//div[2]//button[@class='btn invent-now']"));
