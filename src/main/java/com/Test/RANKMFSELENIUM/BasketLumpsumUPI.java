...
import utility.util;
public class BasketLumpsumUPI extends TestBase {
		...
		public BasketLumpsumUPI(WebDriver driver)
	    {
		...
		public static void selectpaymentmode() throws InterruptedException {
			...
			Thread.sleep(2000);
			WebElement paymentmode=driver.findElement(By.xpath(" //input[@value='upi']"));
			

			try {
				paymentmode.click();
				WebElement enterupi=driver.findElement(By.xpath("//input[@id='upi-input']"));
				enterupi.sendKeys("ravindrac202@okicici");
				Thread.sleep(2000);
				WebElement verifyupi=driver.findElement(By.xpath("//span[normalize-space()='Verify UPI']"));
				verifyupi.click();
